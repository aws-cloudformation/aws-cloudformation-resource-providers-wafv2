...
public class CreateHandlerTest {
    ...
    @Test
    public void testSuccessfulCreateWebACL() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModel)
                .build();

        final WebACLSummary stubWebACLSummary = WebACLSummary.builder()
                .arn(webACL.arn())
                ...
                .build();
        final CreateWebAclResponse stubCreateResponse = CreateWebAclResponse.builder()
                .summary(stubWebACLSummary)
                .build();
        final GetWebAclResponse stubGetResponse = GetWebAclResponse.builder()
                .webACL(webACL)
                .build();

        doReturn(stubCreateResponse).when(proxy).injectCredentialsAndInvokeV2(any(CreateWebAclRequest.class), any());
        doReturn(stubGetResponse).when(proxy).injectCredentialsAndInvokeV2(any(GetWebAclRequest.class), any());
    ...
    @Test
    public void testSuccessfulCreateWebACLCustomRequestAndResponse() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
            .desiredResourceState(resourceModelCustomRequestResponse)
            .build();

        final WebACLSummary stubWebACLSummary = WebACLSummary.builder()
            .arn(webACLCustomRequestResponse.arn())
            .description(webACLCustomRequestResponse.description())
            .id(webACLCustomRequestResponse.id())
            .name(webACLCustomRequestResponse.name())
            .lockToken("dummyLockToken")
            .build();
        final CreateWebAclResponse stubCreateResponse = CreateWebAclResponse.builder()
            .summary(stubWebACLSummary)
    ...
    @Test
    public void testCreateWithStabilization() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModel)
                .build();

        doThrow(WafUnavailableEntityException.builder().build())
                .when(proxy).injectCredentialsAndInvokeV2(any(CreateWebAclRequest.class), any());
        final ProgressEvent<ResourceModel, CallbackContext> response =
                createHandler.handleRequest(proxy, request, null, logger);
    ...
    @Test
    public void testSuccessfulCreateWithCallbackContext() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModel)
                .build();
    ...
    @Test
    public void testFailCreateWithRetryExceeded() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModel)
                .build();
        final CallbackContext callbackContext = CallbackContext.builder()
    ...
    @Test
    public void testCreateWithNullRules() {
    ...
    @Test
    public void testCreateWebACLWithRuleLabelsWithinRules() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModelWithRuleLabelsWithinRules)
                .build();

        final WebACLSummary stubWebACLSummary = WebACLSummary.builder()
                .arn(webACLWithRuleLabelsWithinRules.arn())
                .description(webACLWithRuleLabelsWithinRules.description())
                .id(webACLWithRuleLabelsWithinRules.id())
                .name(webACLWithRuleLabelsWithinRules.name())
                .lockToken("dummyLockToken")
                .build();
        final CreateWebAclResponse stubCreateResponse = CreateWebAclResponse.builder()
                .summary(stubWebACLSummary)
