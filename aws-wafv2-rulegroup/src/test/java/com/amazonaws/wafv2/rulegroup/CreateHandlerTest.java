...
public class CreateHandlerTest {
    ...
    @Test
    public void testSuccessfulCreateRuleGroup() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModel)
                .build();

        final RuleGroupSummary stubRuleGroupSummary = RuleGroupSummary.builder()
                .arn(ruleGroup.arn())
                ...
                .build();
        final CreateRuleGroupResponse stubCreateResponse = CreateRuleGroupResponse.builder()
                .summary(stubRuleGroupSummary)
                .build();
        final GetRuleGroupResponse stubGetResponse = GetRuleGroupResponse.builder()
                .ruleGroup(ruleGroup)
                .build();

        doReturn(stubCreateResponse).when(proxy).injectCredentialsAndInvokeV2(any(CreateRuleGroupRequest.class), any());
    ...
    @Test
    public void testSuccessfulCreateRuleGroupCustomRequestAndResponse() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
            .desiredResourceState(resourceModelCustomRequestResponse)
            .build();

        final RuleGroupSummary stubRuleGroupSummary = RuleGroupSummary.builder()
            .arn(ruleGroupCustomRequestResponse.arn())
            .description(ruleGroupCustomRequestResponse.description())
            .id(ruleGroupCustomRequestResponse.id())
            .name(ruleGroupCustomRequestResponse.name())
            .lockToken("dummyLockToken")
            .build();
        final CreateRuleGroupResponse stubCreateResponse = CreateRuleGroupResponse.builder()
            .summary(stubRuleGroupSummary)
    ...
    public void testCreateWithStabilization() {
        ...
        doThrow(WafUnavailableEntityException.builder().build())
                .when(proxy).injectCredentialsAndInvokeV2(any(CreateRuleGroupRequest.class), any());
        final ProgressEvent<ResourceModel, CallbackContext> response =
                createHandler.handleRequest(proxy, request, null, logger);
    ...
    @Test
    public void testCreateRuleGroupWithRuleLabelWithinRule() {
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
                .desiredResourceState(resourceModelWithRuleLabelsWithinRule)
                .build();

        final RuleGroupSummary stubRuleGroupSummary = RuleGroupSummary.builder()
                .arn(ruleGroupWithRuleLabelsWithinRule.arn())
                .description(ruleGroupWithRuleLabelsWithinRule.description())
                .id(ruleGroupWithRuleLabelsWithinRule.id())
                .name(ruleGroupWithRuleLabelsWithinRule.name())
                .lockToken("dummyLockToken")
                .build();
        final CreateRuleGroupResponse stubCreateResponse = CreateRuleGroupResponse.builder()
                .summary(stubRuleGroupSummary)
